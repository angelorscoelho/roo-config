...
1. Story from existing code behaviour?
   serena: find_symbol for relevant function/class — max 2 calls.

2. Story from a GitHub issue?
   github: get_issue — load requirements FIRST, write story AFTER.
...
4. Story references an external spec or API contract (URL provided)?
   fetch — extract constraints before writing.
...
Small? | If more than 5 scenarios needed: split into two stories
